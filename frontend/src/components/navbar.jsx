  ...
  return (
    <div className="flex justify-around items-center bg-gray-800 text-white py-1 fixed bottom-0 w-full">
      ...
      <button className="flex flex-col items-center text-white">
        <HomeIcon className="h-6 w-6" /> {/* Heroicon for Home */}
        <span>Home</span>
      </button>

      {/* Profile Button */}
      <button className="flex flex-col items-center text-white">
        <UserIcon className="h-6 w-6" /> {/* Heroicon for Profile */}
        <span>Profile</span>
      </button>

      {/* Chat Button */}
      <button
        onClick={toggleChat} // Toggle Chat Panel
        className="flex flex-col items-center text-white"
      >
        <ChatBubbleLeftEllipsisIcon className="h-6 w-6" /> {/* Heroicon for Chat */}
        <span>Chat</span>
      </button>
    </div>
  );
